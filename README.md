...
| Платформа | Скачать |
|---|---|
| Android / Android TV | **[NITOS-2.3.0.apk](https://github.com/Heekuez/nitos-releases/releases/download/v2.3.0/NITOS-2.3.0.apk)** |
| Windows | **[на странице релиза](https://github.com/Heekuez/nitos-releases/releases/latest)** |
| Ubuntu / Debian / Mint | **[nitos_2.3.0_amd64.deb](https://github.com/Heekuez/nitos-releases/releases/download/v2.3.0/nitos_2.3.0_amd64.deb)** |
| Другой Linux | **[NITOS-2.3.0-linux-x64.tar.gz](https://github.com/Heekuez/nitos-releases/releases/download/v2.3.0/NITOS-2.3.0-linux-x64.tar.gz)** |
<!-- /DL -->
